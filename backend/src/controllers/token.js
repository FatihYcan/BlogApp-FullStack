...
module.exports = {
    ...
    list: async (req, res) => {
        ...
        res.status(200).send({ error: false, details: await res.getModelListDetails(Token), data })
    },
    ...
    update: async (req, res) => {
        ...
        res.status(202).send({ error: false, data, new: await Token.findOne({ _id: req.params.id }) })
    },
