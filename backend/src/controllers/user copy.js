...
module.exports = {
    ...
    create: async (req, res) => {
        ...
        */
        ...
        console.log("req.files:", req.files); // Yüklenen dosyaları kontrol et
        console.log("req.body:", req.body); // req.body'yi kontrol et
    ...
    update: async (req, res) => {
        ...
        */
        ...
        //! Mevcut user resmini getir
        const user = await User.findOne(customFilters, { image: 1, _id: 0 })
        for (let file of req.files) {
            //! mevcut user resmini ekle
            user.image.push("./uploads/" + file.filename)
        }

        //! User resmini req.bodye aktar
